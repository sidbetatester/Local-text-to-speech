...
A privacy-focused, browser-based text-to-speech and voice input application. TTS runs 100% locally. Voice input can be 100% local with offline mode enabled.
...
- **🔒 Can Be 100% Local** - Enable offline mode on your device (see setup below)
- **⌨️ Quick Access** - Press M key or click 🎤 button
...
### Voice Input (Speech-to-Text)
Click 🎤 or press `M` to start speaking. Your words will appear in the editor.

**Options:**
- **Continuous mode** - Keep listening until you stop it
